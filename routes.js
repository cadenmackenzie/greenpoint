...
//             stops.push({ address, coordinates: coord }); // Store both the address and its coordinates
//         } else {
//             console.error("Failed to geocode address:", address);
//             res.status(500).send("Geocoding failed for an address");
//             return;
//         }
//     }
...
//         res.json({ location: response.data, stops }); // Send both the route and the stops back to the frontend
//     } catch (error) {
